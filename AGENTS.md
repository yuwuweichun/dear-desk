...
创建或实质修改 HTML 文档前，必须完整阅读：

```text
/Users/song/Desktop/docs-html/AGENTS.md
```
...
- 所有浏览器操作和视觉验证统一使用 `ego-browser`。
- 本地文档验证后保留相关 task space 和必要标签页，关闭无关页面。
...
- 持久化功能必须验证页面重新打开后的状态。
- 前端视觉与交互统一使用 `ego-browser` 验证桌面和移动端。
